...
// Auto-play (optional - uncomment if wanted)
  ...
  <section id="projects" class="relative py-32 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative">
      ...
      >
        ...
        <button
          @click="prevSlide"
          class="absolute left-0 lg:-left-16 top-1/2 -translate-y-1/2 z-40 w-12 h-12 
        ...
        >
          <svg class="w-6 h-6 transform group-hover:-translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          @click="nextSlide"
          class="absolute right-0 lg:-right-16 top-1/2 -translate-y-1/2 z-40 w-12 h-12 
                 rounded-full glass-card flex items-center justify-center
                 text-white/60 hover:text-neon-cyan hover:border-neon-cyan/50
                 transition-all duration-300 group"
          :class="{ 'opacity-50 cursor-not-allowed': filteredProjects.length <= 1 }"
        ...
        <div 
          ref="carouselRef"
          class="relative h-[500px] md:h-[550px] flex items-center justify-center overflow-hidden"
        >
          <div
          ...
          >
            <article class="glass-card overflow-hidden group h-full">
              ...
              <div class="relative aspect-video overflow-hidden bg-dark-800">
                ...
                <div class="absolute inset-0 flex items-center justify-center text-5xl md:text-6xl font-display font-bold text-white/10">
                ...
                >
                  <a
                    ...
                    class="p-3 bg-white/10 rounded-full hover:bg-neon-cyan/20 hover:text-neon-cyan transition-colors"
              ...
              <!-- Content -->
              <div class="p-6">
                <h3 class="text-xl md:text-2xl font-display font-bold mb-3 group-hover:text-neon-cyan transition-colors">
                  {{ project.title }}
                </h3>
