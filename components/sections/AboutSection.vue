    ...
    "Advanced TypeScript"
        ...
        <div v-motion :initial="{ opacity: 0, x: 50 }" :visible-once="{ opacity: 1, x: 0, transition: { delay: 400 } }">
          ...
          <div class="flex flex-wrap gap-4">
            <a :href="`mailto:${profile?.email || 'francois.barlic57@gmail.com'}`" class="inline-flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg 
              ...
              {{ profile?.email || 'francois.barlic57@gmail.com' }}
            </a>
            <a href="https://github.com/FranzouGame" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 bg-white/5 rounded-lg 
                     border border-white/10 hover:border-neon-cyan/30 transition-colors 
                     font-mono text-sm">
